...
def test_training_cache_view_contains_only_shard_refs_and_no_feature_files(tmp_path, monkeypatch) -> None:
    ...
    assert {sample.sample_id for sample in result.view.samples} == {"sample-0", "sample-1", "sample-2"}
