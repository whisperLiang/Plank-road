...
class TrainRequest(_message.Message):
    ...
    num_epoch: int
    payload_zip: bytes
    def __init__(self, edge_id: _Optional[int] = ..., frame_indices: _Optional[str] = ..., cache_path: _Optional[str] = ..., num_epoch: _Optional[int] = ..., payload_zip: _Optional[bytes] = ...) -> None: ...
...
class SplitTrainRequest(_message.Message):
    ...
    num_epoch: int
    payload_zip: bytes
    def __init__(self, edge_id: _Optional[int] = ..., all_frame_indices: _Optional[str] = ..., drift_frame_indices: _Optional[str] = ..., cache_path: _Optional[str] = ..., num_epoch: _Optional[int] = ..., payload_zip: _Optional[bytes] = ...) -> None: ...
