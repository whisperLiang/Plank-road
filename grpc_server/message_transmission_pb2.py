...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_MESSAGETRANSMISSION']._serialized_start=710
  _globals['_MESSAGETRANSMISSION']._serialized_end=933
