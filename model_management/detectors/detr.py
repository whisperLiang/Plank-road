...
DETRDetectionModel = _zoo.DETRDetectionModel
_DETR_MODELS = _zoo._DETR_MODELS


class DETRBackend(DetectionBackend):
    family = "detr"

    def matches_name(self, name: str) -> bool:
        return _zoo._normalise_model_name(name) in _DETR_MODELS

    def matches_model(self, model: torch.nn.Module) -> bool:
        return isinstance(model, DETRDetectionModel)

    def list_model_names(self) -> list[str]:
        return list(_DETR_MODELS)
