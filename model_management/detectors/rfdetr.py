...
RFDETRDetectionModel = _zoo.RFDETRDetectionModel
RFDETRReplay = _split.RFDETRReplay

_RFDETR_MODELS = _zoo._RFDETR_MODELS
_RFDETR_CACHE_VERSION_BUFFER = _zoo._RFDETR_CACHE_VERSION_BUFFER
_RFDETR_CACHE_FORMAT_VERSION = _zoo._RFDETR_CACHE_FORMAT_VERSION
_RFDETR_NMS_IOU_THRESHOLD = _zoo._RFDETR_NMS_IOU_THRESHOLD
_RFDETR_PACKED_AUX_OUTPUTS_MARKER = _split._RFDETR_PACKED_AUX_OUTPUTS_MARKER

ensure_rfdetr_serialization_state = _zoo.ensure_rfdetr_serialization_state
has_compatible_rfdetr_cache_state = _zoo.has_compatible_rfdetr_cache_state
infer_rfdetr_state_dict_num_classes = _zoo.infer_rfdetr_state_dict_num_classes
_postprocess_rfdetr_predictions = _zoo._postprocess_rfdetr_predictions

_patch_rfdetr_decoder_batch_polymorphism = _split._patch_rfdetr_decoder_batch_polymorphism
_pack_rfdetr_aux_outputs = _split._pack_rfdetr_aux_outputs
_unpack_rfdetr_aux_outputs = _split._unpack_rfdetr_aux_outputs
...
class RFDETRBackend(DetectionBackend):
    ...
    def matches_name(self, name: str) -> bool:
        return _zoo._normalise_model_name(name) in _RFDETR_MODELS

    def matches_model(self, model: torch.nn.Module) -> bool:
        return isinstance(model, (RFDETRDetectionModel, RFDETRReplay))

    def list_model_names(self) -> list[str]:
        return list(_RFDETR_MODELS)
